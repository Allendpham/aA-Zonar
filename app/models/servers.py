...
#     'server_users',
#     Base.metadata,
#     db.Column('serverId', db.Integer, ForeignKey(add_prefix_for_prod('servers.id')), primary_key=True),
#     db.Column('userId', db.Integer, ForeignKey(add_prefix_for_prod('users.id')), primary_key=True),
# )
