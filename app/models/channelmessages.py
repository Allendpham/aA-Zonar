...
class ChannelMessage(db.Model):
    ...
    userId = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False, cascade="delete-orphan")
    channelId = db.Column(db.Integer, db.ForeignKey('channels.id'), nullable=False, cascade="delete-orphan")
